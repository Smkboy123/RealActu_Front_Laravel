                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="about-right mb-90">
                            ...
                            <div class="about-prea">
                                <p class="about-pera1 mb-25">{{ $article->conclusion }}</p>
                            </div>
                            <div class="social-share pt-30">
                                <div class="section-tittle">
                                    <h3 class="mr-20">Partager:</h3>
                                    <ul>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <textarea class="form-control w-100 error" name="message" id="message" cols="30" rows="9"
                                                    onfocus="this.placeholder = 'Saisir le message'" onblur="this.placeholder = 'Saisir le message'" placeholder="Enter Message"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control error" name="name" id="name"
                                                    type="text" onfocus="this.placeholder = 'Entrez votre nom'"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control error" name="email" id="email"
                                                    type="email" onfocus="this.placeholder = 'Saisir l\'adresse électronique'"
                                                    onblur="this.placeholder = 'Saisir l\'adresse électronique'"
                                                    placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input class="form-control error" name="subject" id="subject"
                                                    ...
                                                    onblur="this.placeholder = 'Saisir le sujet'"
